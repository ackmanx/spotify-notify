...
const redirect_uri = 'http://localhost:3000/user/callback'; //where to be sent by spotify after logging in. this must be whitelisted in spotify developer dashboard first
